    ...
    <div class="row" >
        <div class="col-lg-9 col-md-12 col-sm-12" >
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="/user/question?userId=${toUser.id?c}">提问</a></li>
            ...
            <#list listQuestion as question>
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p class="text-muted">${user.username}发起问题·${question.commentCount}人回复·${question.createTime?string("yyyy-MM-dd HH:mm:ss")}发起</p>
                    </div>
                </div>
                <hr>
            </#list>
