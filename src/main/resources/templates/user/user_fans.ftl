    ...
    <div class="row" >
        <div class="col-lg-9 col-md-12 col-sm-12" >
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="/user/fans?userId=${toUser.id?c}">粉丝</a></li>
                <#if !user.id??>
            ...
            <hr>
            <#list listUser as fan>
                <div class="media">
                    <div class="media-left">
                        <img class="media-object img-rounded" src="${fan.headerUrl}" alt="#" style="height: 40px">
                    </div>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="/user/question?userId=${fan.id?c}">${fan.username}</a></h4>
                    </div>
                </div>
                <hr>
            </#list>
